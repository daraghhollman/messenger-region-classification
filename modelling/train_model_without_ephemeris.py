...
def main():
    ...
    # to plot later.
    with open(
        "/home/daraghhollman/Main/Work/papers/boundaries/resources/models_without_ephemeris",
        "wb",
    ) as file:
        pickle.dump(models, file)

    with open(
        "/home/daraghhollman/Main/Work/papers/boundaries/resources/testing_confusion_matrices_without_ephemeris",
        "wb",
    ) as file:
        pickle.dump(testing_confusion_matrices, file)

    with open(
        "/home/daraghhollman/Main/Work/papers/boundaries/resources/testing_accuracies_without_ephemeris",
        "wb",
    ) as file:
    ...
    output_file = "/home/daraghhollman/Main/Work/mercury/Code/MESSENGER_Region_Detection/modelling/model_without_ephemeris"
